            ...
            <>
                <KeyboardAvoidingView style={Styles.container} >
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        <LoginInput label="Tipo de PET" />
                        <ModalInput label="Gravidade" onPress={this.controlModal} />
                        <LoginInput label="Nome do PET" />
                        <LoginInput label="Dono do PET" />
                        <TextArea label="Ocorrencia" numberOfLines={3} />
